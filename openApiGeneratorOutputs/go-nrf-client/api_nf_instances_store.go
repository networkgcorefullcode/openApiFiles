...
func (r ApiGetNFInstancesRequest) Execute() (*GetNFInstances200Response, *http.Response, error) {
...
//  @return GetNFInstances200Response
func (a *NFInstancesStoreAPIService) GetNFInstancesExecute(r ApiGetNFInstancesRequest) (*GetNFInstances200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNFInstances200Response
	)
...
func (r ApiOptionsNFInstancesRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *NFInstancesStoreAPIService) OptionsNFInstancesExecute(r ApiOptionsNFInstancesRequest) (*http.Response, error) {
	var (
