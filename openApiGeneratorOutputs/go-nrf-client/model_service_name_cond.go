...
// ServiceNameCond struct for ServiceNameCond
...
func (o *ServiceNameCond) UnmarshalJSON(data []byte) (err error) {
	...
	varServiceNameCond := _ServiceNameCond{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varServiceNameCond)

	if err != nil {
		return err
	}

	*o = ServiceNameCond(varServiceNameCond)
