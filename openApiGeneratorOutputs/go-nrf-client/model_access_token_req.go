...
// SetAnalyticsIds gets a reference to the given []NwdafEvent and assigns it to the AnalyticsIds field.
func (o *AccessTokenReq) SetAnalyticsIds(v []NwdafEvent) {
	o.AnalyticsIds = v
}

// GetRequesterInterIndList returns the RequesterInterIndList field value if set, zero value otherwise.
func (o *AccessTokenReq) GetRequesterInterIndList() []MlModelInterInd {
	if o == nil || IsNil(o.RequesterInterIndList) {
		var ret []MlModelInterInd
		return ret
	}
	return o.RequesterInterIndList
}

// GetRequesterInterIndListOk returns a tuple with the RequesterInterIndList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccessTokenReq) GetRequesterInterIndListOk() ([]MlModelInterInd, bool) {
	if o == nil || IsNil(o.RequesterInterIndList) {
		return nil, false
	}
	return o.RequesterInterIndList, true
}
...
// SetRequesterInterIndList gets a reference to the given []MlModelInterInd and assigns it to the RequesterInterIndList field.
func (o *AccessTokenReq) SetRequesterInterIndList(v []MlModelInterInd) {
	o.RequesterInterIndList = v
}
...
func (o AccessTokenReq) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RequesterInterIndList) {
		toSerialize["requesterInterIndList"] = o.RequesterInterIndList
	}
