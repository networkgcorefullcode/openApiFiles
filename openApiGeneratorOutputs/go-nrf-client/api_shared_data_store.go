...
type ApiGetSharedDataCollectionRequest struct {
	...
	sharedDataIds *SharedDataIdList
	supportedFeatures *string
}

// List of shared data IDs
func (r ApiGetSharedDataCollectionRequest) SharedDataIds(sharedDataIds SharedDataIdList) ApiGetSharedDataCollectionRequest {
...
func (r ApiGetSharedDataCollectionRequest) Execute() ([]SharedData, *http.Response, error) {
...
//  @return []SharedData
func (a *SharedDataStoreAPIService) GetSharedDataCollectionExecute(r ApiGetSharedDataCollectionRequest) ([]SharedData, *http.Response, error) {
	var (
