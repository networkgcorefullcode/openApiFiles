...
// NetworkSliceCond struct for NetworkSliceCond
...
func (o *NetworkSliceCond) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkSliceCond := _NetworkSliceCond{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNetworkSliceCond)

	if err != nil {
		return err
	}

	*o = NetworkSliceCond(varNetworkSliceCond)
