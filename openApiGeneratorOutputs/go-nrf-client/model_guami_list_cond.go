...
// GuamiListCond struct for GuamiListCond
...
func (o *GuamiListCond) UnmarshalJSON(data []byte) (err error) {
	...
	varGuamiListCond := _GuamiListCond{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGuamiListCond)

	if err != nil {
		return err
	}

	*o = GuamiListCond(varGuamiListCond)
